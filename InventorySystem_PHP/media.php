...
<?php include_once('layouts/header.php'); ?>
     <div class="row">
      ...
      <!-- Hidden file input -->
      <input type="file" name="file_upload" multiple="multiple" id="fileInput" class="hidden"/>

      <!-- Custom text button -->
      <label for="fileInput" class="btn btn-link" style="color: blue;">Choose Photo</label>
