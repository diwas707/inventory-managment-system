...
@media print {
    ...
    /* Optionally, hide the footer containing the URL */
    @page {
        @bottom-center {
            content: none;
        }
...
<body>
  <?php if($results): ?>
    <div class="page-break">
       <div class="sale-head">
           <h1>Bhageswor Hardware - Sales Report</h1>
      ...
      <table class="table table-border">
        ...
        <tfoot>
         <tr class="text-right">
           ...
           <td> 
           <?php echo number_format(total_price($results)[0], 2);?> rs
          </td>
         </tr>
         <tr class="text-right">
           <td colspan="4"></td>
           <td colspan="1">Profit</td>
           <td> <?php echo number_format(total_price($results)[1], 2);?> rs</td>
         </tr>
        </tfoot>
      </table>
    </div>
    <div class="text-center">
    <button onclick="window.print();" class="btn btn-primary no-print" id="print-btn">Print</button>
